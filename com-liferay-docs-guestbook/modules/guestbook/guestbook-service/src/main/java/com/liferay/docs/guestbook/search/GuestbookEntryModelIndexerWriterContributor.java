...
public class GuestbookEntryModelIndexerWriterContributor
    ...
    public GuestbookEntryModelIndexerWriterContributor(GuestbookEntryLocalService guestbookEntryLocalService, DynamicQueryBatchIndexingActionableFactory dynamicQueryBatchIndexingActionableFactory) {
        this.guestbookEntryLocalService = guestbookEntryLocalService;
        this.dynamicQueryBatchIndexingActionableFactory =
                dynamicQueryBatchIndexingActionableFactory;
    }

    public void EntryModelIndexerWriterContributor(
            EntryLocalService entryLocalService,
            DynamicQueryBatchIndexingActionableFactory
                    dynamicQueryBatchIndexingActionableFactory) {

        this.guestbookEntryLocalService = (GuestbookEntryLocalService) entryLocalService;
        this.dynamicQueryBatchIndexingActionableFactory =
                dynamicQueryBatchIndexingActionableFactory;
    }
