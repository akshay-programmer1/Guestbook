...
public class GuestbookEntryLocalServiceUtil {
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult
		<GuestbookEntry> searchEntries(
				long companyId, String keywords, int start, int end,
				long guestbookId)
			throws PortalException {

		return getService().searchEntries(
			companyId, keywords, start, end, guestbookId);
	}

	public static int searchGuestbookEntriesCount(
			long companyId, String keywords, long guestbookId)
		throws PortalException {

		return getService().searchGuestbookEntriesCount(
			companyId, keywords, guestbookId);
	}
	...
	private static final Snapshot<GuestbookEntryLocalService> _serviceSnapshot =
		new Snapshot<>(
			GuestbookEntryLocalServiceUtil.class,
