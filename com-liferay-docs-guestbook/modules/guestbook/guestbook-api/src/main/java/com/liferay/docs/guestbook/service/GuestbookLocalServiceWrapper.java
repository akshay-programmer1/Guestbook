...
public class GuestbookLocalServiceWrapper
	...
	public BaseModelSearchResult
		...
		return _guestbookLocalService.searchEntries(
			companyId, keywords, start, end, guestbookId);
	}

	@Override
	public BaseModelSearchResult<com.liferay.docs.guestbook.model.Guestbook>
		searchGuestbookEntries(
			long companyId, String keywords, int cur, int delta) {

		return _guestbookLocalService.searchGuestbookEntries(
	...
	public BaseModelSearchResult<com.liferay.docs.guestbook.model.Guestbook>
		...
		return _guestbookLocalService.searchGuestbookEntries(
			companyId, keywords, start, delta);
	}
