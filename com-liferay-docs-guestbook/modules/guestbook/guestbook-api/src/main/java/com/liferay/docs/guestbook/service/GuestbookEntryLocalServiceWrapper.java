...
public class GuestbookEntryLocalServiceWrapper
	...
	public com.liferay.portal.kernel.search.BaseModelSearchResult
		<com.liferay.docs.guestbook.model.GuestbookEntry> searchEntries(
				long companyId, String keywords, int start, int end,
				long guestbookId)
			throws com.liferay.portal.kernel.exception.PortalException {

		return _guestbookEntryLocalService.searchEntries(
			companyId, keywords, start, end, guestbookId);
	}

	@Override
	public int searchGuestbookEntriesCount(
			long companyId, String keywords, long guestbookId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _guestbookEntryLocalService.searchGuestbookEntriesCount(
